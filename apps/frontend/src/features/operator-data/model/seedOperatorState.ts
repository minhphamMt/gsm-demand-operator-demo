...
const drivers: readonly DemoDriver[] = [
  ...
  { id: 'DRV-003', name: 'Thu Hà', status: 'online_idle', homeZoneId: 'AI-Z05', distanceKm: 4.6, shiftEndsInMinutes: 65, acceptedOfferIds: [], rewardTotal: 45_000 },
  { id: 'DRV-004', name: 'Đức Long', status: 'offline', homeZoneId: 'AI-Z09', distanceKm: 5.2, shiftEndsInMinutes: 180, acceptedOfferIds: ['OFF-104'], rewardTotal: 100_000 },
  { id: 'DRV-005', name: 'Ngọc Mai', status: 'online_busy', homeZoneId: 'AI-Z11', distanceKm: 1.4, shiftEndsInMinutes: 40, acceptedOfferIds: [], rewardTotal: 45_000 },
  { id: 'DRV-006', name: 'Hải Nam', status: 'en_route', homeZoneId: 'AI-Z13', distanceKm: 2.8, shiftEndsInMinutes: 150, acceptedOfferIds: ['OFF-106'], rewardTotal: 55_000 },
  ...
  { id: 'DRV-008', name: 'Tuấn Kiệt', status: 'online_idle', homeZoneId: 'AI-Z18', distanceKm: 3.9, shiftEndsInMinutes: 110, acceptedOfferIds: [], rewardTotal: 45_000 },
]
...
function historicalPlans(currentPlans: readonly Proposal[]): Proposal[] {
  ...
  return [
    ...
    { ...saving, id: 'PLN-038', rootProposalId: 'PLN-038', parentProposalId: null, title: 'Bổ sung cung Tây Hồ', status: 'Approved', rank: 1, createdAt: atMinutes(-190), inputSnapshotId: 'SNP-HN-1345', hotspotId: 'HOT-07-1345', targetZoneId: 'AI-Z05', targetZoneLabel: 'Tây Hồ 1', moves: retarget(saving, 'AI-Z05', 'Tây Hồ 1') },
    ...
    { ...saving, id: 'PLN-036', rootProposalId: 'PLN-036', parentProposalId: null, title: 'Bổ sung cung Hoàng Mai', status: 'Approved', rank: 1, createdAt: atMinutes(-320), inputSnapshotId: 'SNP-HN-1130', hotspotId: 'HOT-10-1130', targetZoneId: 'AI-Z08', targetZoneLabel: 'Hoàng Mai 1', moves: retarget(saving, 'AI-Z08', 'Hoàng Mai 1') },
  ]
}
...
function seededOffers(): Offer[] {
  const zoneNames: Record<string, string> = { 'AI-Z02': 'Hoàn Kiếm', 'AI-Z05': 'Tây Hồ', 'AI-Z08': 'Hoàng Mai' }
