...
export function LoginPage() {
  ...
  return <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[#e8eeee] px-4 py-10">
    ...
    <section className="relative w-full max-w-sm rounded-xl border border-slate-300 bg-white p-7 shadow-[0_24px_80px_rgba(15,23,42,.16)]">
      <div className="flex items-center gap-3"><img alt="NovaFour Ops" className="size-10" src={novafourOpsMark} /><div><p className="font-black tracking-tight">NOVAFOUR OPS</p><p className="text-[9px] font-bold uppercase tracking-[.18em] text-slate-500">AI fleet control</p></div></div>
