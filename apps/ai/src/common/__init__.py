...
Sẽ chứa (docs/design/ARCHITECTURE.md §7):
    ...
    errors.py     exception nghiệp vụ mang error_code khớp docs/design/API_CONTRACT.md §1.2

Ràng buộc kiến trúc: package này KHÔNG import bất kỳ package nào khác của src/
(docs/design/ARCHITECTURE.md §6.2) — nếu nó phụ thuộc ngược lên tầng trên thì mọi tầng đều
