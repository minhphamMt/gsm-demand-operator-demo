...
const proposal = (overrides: Partial<Proposal>): Proposal => ({
  ...
  scenarioId: 'rain-peak', generatorType: 'AGENT', generatorVersion: 'v1', inputSnapshotId: 's1', hotspotId: 'h1', targetZoneId: 'AI-Z02', targetZoneLabel: 'HoÃ n Kiáº¿m', confidence: null,
