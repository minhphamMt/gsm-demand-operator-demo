...
const candidateSourceZones = [
  { zoneId: 'AI-Z06', label: 'Cầu Giấy 1', availableSupply: 16, distanceKm: 6.8, etaMinutes: 22 },
  { zoneId: 'AI-Z04', label: 'Đống Đa 1', availableSupply: 14, distanceKm: 3.4, etaMinutes: 12 },
  { zoneId: 'AI-Z05', label: 'Tây Hồ 1', availableSupply: 15, distanceKm: 5.6, etaMinutes: 18 },
  { zoneId: 'AI-Z07', label: 'Thanh Xuân 1', availableSupply: 13, distanceKm: 6.2, etaMinutes: 20 },
] as const
...
const strategies: readonly Strategy[] = [
  { title: 'Ưu tiên thời gian chờ', targetDriverCount: 8, relocationBonus: 60_000, zoneTripBonus: 12_000, fareMultiplier: 1, budgetLimit: 900_000, confidence: 0.92, moves: [move('MOV-01', 'AI-Z06', 'Cầu Giấy 1', 'AI-Z02', 'Hoàn Kiếm 1', 4, 6.8, 22, 12), move('MOV-02', 'AI-Z05', 'Tây Hồ 1', 'AI-Z02', 'Hoàn Kiếm 1', 4, 5.6, 18, 11)] },
  { title: 'Cân bằng hiệu quả và chi phí', targetDriverCount: 6, relocationBonus: 55_000, zoneTripBonus: 10_000, fareMultiplier: 1.05, budgetLimit: 650_000, confidence: 0.89, moves: [move('MOV-03', 'AI-Z04', 'Đống Đa 1', 'AI-Z02', 'Hoàn Kiếm 1', 3, 3.4, 12, 11), move('MOV-04', 'AI-Z05', 'Tây Hồ 1', 'AI-Z02', 'Hoàn Kiếm 1', 3, 5.6, 18, 12)] },
  { title: 'Kiểm soát ngân sách', targetDriverCount: 4, relocationBonus: 45_000, zoneTripBonus: 5_000, fareMultiplier: 1.1, budgetLimit: 350_000, confidence: 0.84, moves: [move('MOV-05', 'AI-Z06', 'Cầu Giấy 1', 'AI-Z02', 'Hoàn Kiếm 1', 2, 6.8, 22, 14), move('MOV-06', 'AI-Z07', 'Thanh Xuân 1', 'AI-Z02', 'Hoàn Kiếm 1', 2, 6.2, 20, 11)] },
]
...
export function createAgentPlans(scenarioId: DemoScenarioId, startingPlanNumber = 42): Proposal[] {
  ...
  return strategies.map((strategy, index) => {
    ...
    return completeProposal({
      ...
      scenarioId, generatorType: 'AGENT', generatorVersion: 'gsm14-agent/1.4.0', inputSnapshotId: `SNP-${scenarioId}-${snapshotSuffix}`, hotspotId: `HOT-04-${snapshotSuffix}`, targetZoneId: 'AI-Z02', targetZoneLabel: 'Hoàn Kiếm 1', confidence: strategy.confidence, candidateSourceZones,
