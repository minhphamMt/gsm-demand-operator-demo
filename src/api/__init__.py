...
Sẽ chứa (ARCHITECTURE.md §7):
    ...
    errors.py  map exception nghiệp vụ → HTTP status theo API_CONTRACT.md §1.2
...
GET /health nằm ngoài /api/v1 và được định nghĩa ở src/main.py (API_CONTRACT.md §8.2).
"""
